...
module.exports =
	version: 1
	slug: 'generic-amd64-xr'
	name: 'Generic x86_64 (GPT) xr'
	arch: 'amd64'
	state: 'new'
	...
	yocto:
		machine: 'generic-amd64-xr'
		image: 'balena-image-flasher'
		fstype: 'balenaos-img'
		version: 'yocto-scarthgap'
		deployArtifact: 'balena-image-flasher-generic-amd64-xr.balenaos-img'
		deployFlasherArtifact: 'balena-image-flasher-generic-amd64-xr.balenaos-img'
		deployRawArtifact: 'balena-image-generic-amd64-xr.balenaos-img'
		compressed: true
